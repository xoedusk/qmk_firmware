...
// $ qmk compile -kb splitkb/aurora/sofle_v2 -km sofle_xoe
//
// Move with
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	KC_GRV,		KC_1,			KC_2,			KC_3,			KC_4,			KC_5,										KC_6,		KC_7,		KC_8,		KC_9,		KC_0,		KC_DEL,
      ...
      KC_LSFT,	KC_Z,			KC_X,			KC_C,			KC_V,			KC_B,			G(C(KC_X)),		SILENT,		KC_N,		KC_M,		KC_COMM,	KC_DOT,		KC_SLSH,	KC_ENT ,
      							KC_LCTL,		KC_LALT,		KC_LGUI, 		KC_SPC,			NUMBER,			SYMBOL,		KC_SPC,		KC_RSFT,	KC_DOWN,	KC_RGHT
		),
	...
	[_SILENT] = LAYOUT(
		...
		XXXXXXX,	XXXXXXX,	XXXXXXX,	XXXXXXX,	XXXXXXX,	XXXXXXX,	XXXXXXX,		XXXXXXX,	XXXXXXX,	XXXXXXX,	XXXXXXX,	XXXXXXX,	XXXXXXX,	XXXXXXX,
								XXXXXXX,	XXXXXXX,	XXXXXXX,	XXXXXXX,	NUMBER,			SYMBOL,		XXXXXXX,	XXXXXXX,	XXXXXXX,	XXXXXXX
		),
	...
	[_SYMBOL] = LAYOUT(
		KC_ESC,		RGB_HUI,	RGB_SAI,	RGB_VAI,	RGB_MOD,	EE_CLR,									DB_TOGG,	XXXXXXX,	KC_UP,		XXXXXXX,	XXXXXXX,	KC_DEL,
		...
		KC_LSFT,	XXXXXXX,	XXXXXXX,	XXXXXXX,	XXXXXXX,	XXXXXXX,	XXXXXXX,		XXXXXXX,	XXXXXXX,	XXXXXXX,	XXXXXXX,	XXXXXXX,	KC_LBRC,	KC_ENT,
								KC_LCTL,	KC_LALT,	KC_LGUI,	KC_SPC,		QWERTY,			_______,	KC_SPC,		KC_RSFT,	G(C(KC_X)),	SILENT
		)
};
